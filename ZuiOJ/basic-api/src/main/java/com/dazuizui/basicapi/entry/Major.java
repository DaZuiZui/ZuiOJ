...
public class Major implements Serializable {
    ...
    public Major(Long id, Long college, String chineseName, String englishName, String createBy, Long createById, Date createTime, String updateBy, Long updateById, Date updateTime, int delFalg, int status) {
        this.id = id;
        this.college = college;
        this.chineseName = chineseName;
        this.englishName = englishName;
