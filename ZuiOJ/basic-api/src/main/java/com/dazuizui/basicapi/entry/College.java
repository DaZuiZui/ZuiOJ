...
public class College implements Serializable {
    ...
    public College(Long id, Long universty, String chineseName, String englishName, String createBy, Long createById, Date createTime, String updateBy, Long updateById, Date updateTime, int delFalg, int status) {
        this.id = id;
        this.universty = universty;
        this.chineseName = chineseName;
        this.englishName = englishName;
