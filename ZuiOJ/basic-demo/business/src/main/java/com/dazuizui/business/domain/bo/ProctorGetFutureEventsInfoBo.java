 ...
 * 监考员获取我该监考的项目
 */
public class ProctorGetFutureEventsInfoBo implements Serializable {
    ...
    public ProctorGetFutureEventsInfoBo() {
    }

    public ProctorGetFutureEventsInfoBo(String proctorToken, Long start, Long size, String token) {
        this.proctorToken = proctorToken;
        this.start = start;
        this.size = size;
        this.token = token;
