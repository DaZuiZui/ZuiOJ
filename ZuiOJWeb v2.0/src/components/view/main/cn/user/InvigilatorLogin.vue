            ...
            <div class="container">
                ...
                <div class="row mb-5 justify-content-center text-center">
                    <div class="col-lg-6">
                        ...
                        <h2 class=" mt-4">Hi 监考员，登入您的账户</h2>
                        <div class="mt-2">
                        ...
                        <div>
                                <div class="form-group">
                                  ...
                                  <small id="emailHelp" class="form-text text-muted">请输入管理员账号或者监考账号</small>
                                </div>
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Password</label>
                                  <input type="password" class="form-control" id="exampleInputPassword1" v-model="user.password">
                                  <small id="emailHelp" class="form-text text-muted">请输入您的密码</small>
                                </div>
                                <div class="form-group form-check">
                                   如果您忘记了密码，请通过联系邮箱进行修改。
                                </div>
                                <button  class="btn btn-primary" style="width:100%" @click="submit()"   :disabled="switchbutton">Login</button>
