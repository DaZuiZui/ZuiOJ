      ...
      <section  style="background-color:#f9f9f9">
          <div class="row mb-5 justify-content-center text-center" >
              <div class="col-lg-9"  >
                  ...
                  <h2 class=" mt-4"> 创建题解</h2>
                  <div class="mt-2">
                      <p class="lead lh-180"> Create Question Anser </p>
                  </div>
...
export default {
  ...
  methods: {
      ...
      async submit(){
          ...
          var object = await synRequestPost("/blog/createQuestionAnswer?questionId="+getQueryVariable("id"),this.article);
