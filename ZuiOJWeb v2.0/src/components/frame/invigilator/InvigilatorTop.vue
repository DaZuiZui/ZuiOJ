                                    ...
                                    <el-dropdown-menu slot="dropdown" class="position:fixed"  style="width: 300px;">
                                        <div v-if="user.role != -1">
                                            ...
                                            <div style="margin: auto;"  >                              
                                                ...
                                                <li tabindex="-1" class="el-dropdown-menu__item" style="text-align:center"   ><i class="el-icon-user"></i>我所负责的比赛</li>
                                                ...
                                                <li tabindex="-1" class="el-dropdown-menu__item" style="text-align:center"   ><i class="el-icon-user"></i>我的操作日志</li>
